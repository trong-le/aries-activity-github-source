...
### State
The state parameter specifies the state of the pull request or issue inside of a repository. Default is `all`. This parameter is used in `listPullRequests` and `listIssues`.
```javascript
"state": "closed"
```
