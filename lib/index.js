...
export default class GithubSource extends Activity {
    ...
    /**
      ...
      */
    async listIssues({ repo, owner }, gh) {
    ...
    async listIssueComments({ repo, number, owner }, gh) {
    ...
    async listRepoComments({ repo, owner }, gh) {
    ...
    async listPullRequests({ repo, state, owner }, gh) {
    ...
    async listRepoCommits({ repo, owner, since, until }, gh) {
